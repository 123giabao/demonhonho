...
sheet_problems = client.open_by_key("1BzKlU9mx9jIIkZzQJlLXvk9iOHc5eR3U84Do3SS5fH4").sheet1


try:
    sheet_submissions = client.open_by_key("1Zfr9EUWGuXzn9xk7iYG80YnF4A60B1d1XLK_yMXt7Us").worksheet("lichsu")
except:
    spreadsheet = client.open_by_key("1Zfr9EUWGuXzn9xk7iYG80YnF4A60B1d1XLK_yMXt7Us")
    sheet_submissions = spreadsheet.add_worksheet(title="lichsu", rows="1000", cols="10")
...
try:
    sheet_lichsu = client.open_by_key("1Zfr9EUWGuXzn9xk7iYG80YnF4A60B1d1XLK_yMXt7Us").worksheet("lichsu")
except:
    spreadsheet = client.open_by_key("1Zfr9EUWGuXzn9xk7iYG80YnF4A60B1d1XLK_yMXt7Us")
    sheet_lichsu = spreadsheet.add_worksheet(title="lichsu", rows="1000", cols="20")
...
# cái này công thức tính điểm trung bình lụm trên mạng
        try:
        ...
        if user_row_idx:
            ...
            print(f"✅ Đã cập nhật lịch sử cho {username} (hàng {user_row_idx})")
        else:
            # Append new row
